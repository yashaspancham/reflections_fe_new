...
const SideBarMenu = () => {
  ...
  return (
    loaded && (
      <div
        className={`flex max-lg:flex-wrap max-lg:gap-2 lg:flex-col lg:justify-between fixed lg:sticky z-10 left-0 bottom-0 lg:top-0 bg-blue-800 min-h-20 min-w-full lg:min-w-[200px] lg:h-[100vh]`}
      >
            ...
            <button
              ...
              flex items-center max-lg:justify-between lg:px-5 gap-5 lg:w-full hover:cursor-pointer max-lg:mt-2 max-lg:p-3 lg:py-5
               rounded-md text-md sm:text-lg
                lg:text-2xl text-white max-lg:bg-blue-900 hover:bg-blue-700 ${
