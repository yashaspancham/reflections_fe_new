...
import { addTask } from "@/APIs/Task/task";
          ...
          <div className="flex gap-2 text-xs">
            ...
            onClick={()=>setTaskStatus("pending")}
              className={`rounded-lg p-2 hover:cursor-pointer ${
                taskStatus === "pending" ? "bg-purple-600 hover:bg-purple-700 text-white" : "hover:bg-purple-100"
              }`}
            >
              Pending
            </button>
            ...
            onClick={()=>setTaskStatus("in_progress")}
              className={`rounded-lg p-2 hover:cursor-pointer ${
                taskStatus === "in_progress" ? "bg-purple-600 hover:bg-purple-700 text-white" : "hover:bg-purple-100"
              }`}
            >
              In-Process
            </button>
            ...
            onClick={()=>setTaskStatus("completed")}
              className={`rounded-lg p-2 hover:cursor-pointer ${
                taskStatus === "completed" ? "bg-purple-600 hover:bg-purple-700 text-white" : "hover:bg-purple-100"
              }`}
            >
              Completed
            </button>
